...
At 1pm you're doing a **compliance-focused demo** for a bank. At 3pm you're doing a **developer-focused deep dive** for a startup.
...
At 12:55, you **Open Stax → Bank Demo**.
Everything is ready. No scramble.

At 2:55, you close it and **Open Stax → Developer Deep Dive**.
New tenant, new docs, new script.
...
At 10:00 you have a **QBR with a happy, expanding account**.
At 11:00 you have a **tense call with a renewal-risk customer**.
...
You **share Board Pack Stax with your CFO / finance person**.
You **share Bug Stax with eng lead & support head**.
You **share Prospect Pricing Stax with sales lead**.
...
Postmortem Stax Start Page:
*"Write root cause summary in human language; capture 3 action items max."*

Reliability Stax Start Page:
*"Look at SLO burn-down → identify top 2 violators → assign owners."*
...
You **share Gas Leak Stax with field commanders & utility**.
You **share Storm Alpha Stax with city leadership, police, public works, Red Cross**.
...
You **share Live Stax with observers (PM, designer)** so they can join and take notes without asking for links.
You **share Synthesis Stax with the same folks** so they can see the emerging picture.
...
When anyone asks "Where's the latest version?", the answer is:
**"Open the Launch Stax."**
...
They start a **weekly accountability call**.
...
Different Anne.
She's building an app, and she's decided: she doesn't care about "scale" yet. She cares about **"one real paying customer at a time"**.
...
Her metric becomes:
"How many Customer Stax have moved from 'exploring' to 'paid'?"
...
They're newly sober.
Life is now three overlapping, fragile layers:
...
When things get wobbly, the action is: **open Recovery Stax**.
No search. No choice architecture. Just the next right tools.
...
When they say, "I'm doing uni work now," they open Uni Stax and close the others.
When they say, "I'm doing client work now," they open Side Hustle Stax and stand in that frame.
...
He **shares the Research Stax with a parent or mentor** so they can see choices instead of nagging abstractly.
He **shares the Essays Stax with an English teacher or older sibling** who can leave comments in context.

Now "college stuff" isn't amorphous. It's:
**open the Applications Stax, do the next visible thing, close it.**
Less swirl, more progress.
...
She's in university.
Her grades are tanking. She's behind in three modules, ashamed, and dodging emails.
...
When she opens this Stax, the chaos is structured:
modules listed, deadlines visible, one action highlighted.
...
Once a week, he opens this Stax **on purpose**.
Not to catastrophize, but to take one small corrective action per alarm.
...
They open the Stax once or twice a week as "estate time," handle one cluster, then close it.
Instead of "I should be doing everything," they're doing *something* in a defined container.
...
Once a week, she opens this Stax **on purpose**.
Not to fix her entire life, but to move one experiment forward: book a therapy consult, sign up for a class, send an email, set a coffee with someone in a job she admires.
...
He's also now a **candidate for state senate**.

He cares about policy, ideas, students.
But the campaign is a different beast:
...
3. **"Personal – Health & Mental Bandwidth"**
...
4. **"Family – Safety, Boundaries, & Support"**
